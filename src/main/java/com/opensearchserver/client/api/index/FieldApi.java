...
import com.opensearchserver.client.api.index.result.ResultField;
import com.opensearchserver.client.api.index.result.ResultFieldList;
import com.opensearchserver.utils.HttpUtils;
import com.opensearchserver.utils.LinkUtils;

public class FieldApi extends AbstractApi<JsonClientAbstract> {

	public FieldApi(JsonClientAbstract client) {
		super(client);
	}
